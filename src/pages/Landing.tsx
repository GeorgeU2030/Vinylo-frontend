    ...
    <div className="bg-light">
      <Navbar />
        ...
        <section className="flex mt-2 flex-col items-center justify-center w-full min-h-72">
          <h1 className="my-2 font-bold text-2xl bg-gradient-to-r from-pomeorange via-pomedark to-pomepeach bg-clip-text text-transparent">Rank your favorite artists across different levels</h1>
        ...
        <section className="flex mt-2 flex-col items-center justify-center w-full">
            ...
            <h1 className="my-3 font-bold text-2xl bg-gradient-to-r from-pomedark via-pomepinkdark to-pomepink bg-clip-text text-transparent">Thank you for using PomeMusic!</h1>
            <p className="w-5/6 mb-6 md:w-1/2 text-center text-graydark font-semibold">
